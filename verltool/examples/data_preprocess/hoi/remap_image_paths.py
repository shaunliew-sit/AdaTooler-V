...
Usage (run on cluster from verltool/):
    python examples/data_preprocess/hoi/remap_image_paths.py \
        --hico_cluster_dir /home/users/sit/a104059/scratch/data/hico_20160224_det \
        --swig_cluster_dir /home/users/sit/a104059/scratch/data/swig_hoi \
        --parquet_dir data/hoi
"""
import argparse
